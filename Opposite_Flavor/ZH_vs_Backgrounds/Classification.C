...
int Classification(TString weightName){
    ...
    TTree *signalTrain = (TTree*)input_signal->Get("t_BDT_OF_train");
    TTree *signalTest  = (TTree*)input_signal->Get("t_BDT_OF_test");
    TTree *bkgdTrain   = (TTree*)input_bkgd->Get("t_BDT_OF_train");
    TTree *bkgdTest    = (TTree*)input_bkgd->Get("t_BDT_OF_test"); 
...
//					  "nTrain_Signal=0:nTest_Signal=0:nTrain_Background=0:nTest_Background=0:SplitMode=Random:!V" );
    ...
    if (Use["BDTG"])
        factory->BookMethod( dataloader, TMVA::Types::kBDT, "BDTG",
                           "!H:!V:NTrees=800:MinNodeSize=5%:BoostType=Grad:nCuts=20:MaxDepth=3:SeparationType=SDivSqrtSPlusB" );
