void makeMVAPlots(TString tag){
     ...
     for (int i = 0; i < procs.size(); i++ ){
	  ...
	  legend->AddEntry(h_1,procs[i],"f");
	  hs_MVA_2_scores->Add(h_2);
	  legend1->AddEntry(h_2,procs[i],"f");
     ...
     h1->GetXaxis()->SetRangeUser(0.7,1.0);
     h2->GetXaxis()->SetRangeUser(0.7,1.0);
     h3->GetXaxis()->SetRangeUser(0.7,1.0);
     h4->GetXaxis()->SetRangeUser(0.7,1.0);

     h1->GetYaxis()->SetRangeUser(0.0,0.3);
     h2->GetYaxis()->SetRangeUser(0.0,0.3);
     h3->GetYaxis()->SetRangeUser(0.0,0.3);
     h4->GetYaxis()->SetRangeUser(0.0,0.3);
